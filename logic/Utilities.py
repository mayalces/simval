...
class Utilities():
    ...
    def generate_one_map_file(self, data, meta_data, type, file_name):
    ...
    def generate_map_disto_file(self, data, meta_data, file_name):
    ...
    def generate_mst_map_file(self, data, meta_data, file_name):
    ...
    def real_data_format2(self, input_file):
        ...
        for i in range(3, len(f[0])):
            for e in range(len(f)):
                if f[e][i] == f[e][1]:
                    ...
                    list1.append(np.random.choice([0, 1]))
                    list2.append(np.random.choice([0, 1]))
                else:
                    list1.append(1)
                    list2.append(0)
            population.append([list1, list2])
            list1 = []
            list2 = []
        ...
        for l in f:
            for i in range(len(l)):
                if i == 1 or i == 2:
                    ...
                    if file_format == "OM" and i == 0:
                        result_file.write("*M" + "%s\t" % l[i])
                    else:
...
if __name__ == '__main__':
    ...
    u = Utilities()
    #u.real_data_format("pruebas/Escenario4/P2/caroteno.txt", "pruebas/Escenario4/P2/carotenoMD.xls", "MD")
    #u.real_data_format("pruebas/Escenario4/P1/arrozMyMap.txt", "pruebas/Escenario4/P1/arrozMyMapOM.raw", "OM")
    #u.real_data_format("pruebas/Escenario4/P1/arrozMyMap.txt", "pruebas/Escenario4/P2/arrozMyMapMM.txt", "MM")
    u.real_data_format2("pruebas/Escenario4/P1/arroz.txt")
#     a = [1, 2, 3, 4, 5, 6, 7, 8, 9]
#     b = [1, 8, 9, 4, 4, 3, 4, 2, 5]
